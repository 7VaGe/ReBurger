        ...
        <figure class="card card-product-grid bg-dark rounded-6 shadow">
          ...
          <p class="title mb-2"><?php echo str_replace('_', ' ', $prodotto["nome"])?></p>
                ...
                <div class="text-center">
                  <ahref="#" data-name="<?php echo $prodotto["nome"]?>" data-price="<?php echo $prodotto["prezzo"]?>" class="add-to-cart btn btn-warning m-3" id="addToCart" onclick="alertHandler()" >Aggiungi al carrello</a>
                </div>
