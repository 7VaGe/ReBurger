...
<div class="album mb-5 bg-dark text-white">
  <div class="text-center mb-4">
    ...
    <form class="form-inline m-3  d-flex justify-content-center">
      <input class="form-control mr-sm-2 w-50" type="Search" placeholder="Inserisci il nome del prodotto" aria-label="Search" >
      <button class="btn btn-outline-warning my-sm-0 search" id="myInput" type="submit">Search</button>
    </form>

<!-- Inserisco una barra di ricerca per il prodotto che mi serve da modificare  -->
