<div class="text-center form-signin">
  <form action="contatti.php" method="get">
    ...
    <div class="container-lg">
      ...
      <div class="form-floating d-flex">
          <input type="text" class="form-control my-2" id="descrizione" value="<?php echo $info["descrizione"] ?>" name="descrizione" /> 
          <label for="floatingInput">descrizione</label>
      </div>
      <div class="form-floating d-flex">
          <input type="text" class="form-control my-2" id="descrizione1" value="<?php echo $info["descrizione1"] ?>" name="descrizione1" /> 
          <label for="floatingInput">descrizione1</label>
      </div>
      <div class="form-floating d-flex">
          <input type="text" class="form-control my-2" id="descrizione2" value="<?php echo $info["descrizione2"] ?>" name="descrizione2" /> 
          <label for="floatingInput">descrizione2</label>
      </div>
      <div class="form-floating d-flex">
          <input type="text" class="form-control my-2" id="descrizione3" value="<?php echo $info["descrizione3"] ?>" name="descrizione3" /> 
          <label for="floatingInput">descrizione3</label>
      </div>
      <div class="form-floating d-flex">
          <input type="text" class="form-control my-2" id="nome_locale4" value="<?php echo $info["nome"] ?>" name="nome_locale" /> 
